...
public class CustumAOP {
	...
	@AfterThrowing("execution(* com.cyh.b1.member.MemberService.memberJoin(..))")
	public void afterThrowing()throws Exception {
		System.out.println("after throwing");
	}
	
	@After("execution(* com.cyh.b1.member.MemberService.memberJoin(..))")
	public void after()throws Exception {
		
		System.out.println("after");
	}
	
	@Around("execution(* com.cyh.b1.member.MemberService.memberLogin(..))")
